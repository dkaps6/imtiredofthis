...
def main()->int:
    ...
    usage=out/"usage_regime_context.csv"; room=out/"room_continuity_context.csv"; joined=out/"role_room_context.csv"; transition=out/"role_room_transition_detail.csv"; transition_summary=out/"role_room_transition_summary.csv"; eventq=out/"event_regime_qualification.csv"; stability=out/"role_room_stability.csv"; profile=out/"role_room_candidate_profile.csv"; redundancy=out/"role_room_redundancy_audit.csv"
